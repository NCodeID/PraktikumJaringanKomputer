# Laporan Praktikum Jaringan Komputer ( susulan )
...
**Tujuan:**  
Melihat cara traceroute bekerja dengan TTL dan pesan ICMP TTL-exceeded.

**Langkah:**  
1. Ketik perintah traceroute pada terminal lalu arahkan ke `gaia.cs.umass.edu` dengan ukuran 56 byte.  
...
**Screenshot:**  
- **Part 1:** ![IPv4 dasar](./gambar/gambar_1.png)
- **Part 2:** ![IPv4 dasar](./gambar/gambar_2.png)
- **Part 3:** ![IPv4 dasar](./gambar/gambar_3.png)
...
**Screenshot:**  
- **UDP 3000:** ![Fragmentasi UDP](./gambar/udp_3000.png)
...
**Screenshot:**  
- **IPv6:** ![IPv6 DNS AAAA](./gambar/IPv6.png)
