...
![screenshot_ping_cmd](./gambar/imcpFilter.png)
...
- Waktu respons (RTT): Minimum 80ms, Maksimum 93ms, Rata-rata 85ms
- Setiap reply menunjukkan byte size, response time, dan TTL value (46)

Statistik ini membuktikan bahwa host tujuan aktif dan merespons dengan baik.

## 2. Detail Paket ICMP Echo Request di Wireshark

![screenshot_echo_request](./gambar/icmpReply.png)
...
![screenshot_echo_reply](./gambar/icmpReply.png)
...
- Destination Address: 192.168.0.100 (kembali ke host pengirim)
- Identifier (BE): 1 (0x0001) - sama dengan request
- Sequence Number: 26 (0x001a) - sama dengan request
- Response Time: 82.453 ms
- Total paket: 74 bytes
...
## 4. LANGKAH PRAKTIKUM TRACEROUTE
...
![screenshot_tracert_cmd](./gambar/tracert.png)
...
- Total 17 hop yang dilalui paket untuk sampai ke tujuan
...
![screenshot_ttl_detail](./gambar/TTL.png)
...
- Destination Address: 192.168.1.100 (kembali ke host pengirim)
